...
cd tests
npm ci          # once
npm test        # 212 assertions, node + jsdom, seconds
npm run test:rules   # 199 rules assertions (needs Java + firebase-tools)
...
reaches through an org boundary. All 411 pass as of this writing — a
